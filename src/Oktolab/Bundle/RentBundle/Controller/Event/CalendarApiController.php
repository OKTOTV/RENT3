...
class CalendarApiController extends Controller
{
    ...
    {
        $inventory = $this->get('oktolab.event_calendar_inventory')->getTransformedInventory(true, $this->container->getParameter('calendar_list_setItems'));
    ...
    /** Returns JSON formatted Timeblocks for inventory
     *
     * @Configuration\Cache(expires="+5 min", public="yes")
     * @Configuration\Method("GET")
     * @Configuration\Route("/inventory_day_timeblock.{_format}/{begin}/{end}",
     *      name="orb_calendar_api_inventory_day_timeblocks",
     *      defaults={"_format"="json", "begin" = "default", "end" = "default"},
     *      requirements={"_format"="json"})
     *
     * @Configuration\ParamConverter("begin",
     ...
     * @return JsonResponse
     */
    public function InventoryDayTimeblockAction(\DateTime $begin, \DateTime $end)
    {
        $timeblocks = $this->get('oktolab.event_calendar_timeblock')->getDayTimeblocks($begin, $end);
        return new JsonResponse($timeblocks);
    }
