(function (window, document, $, Oktolab) {
     ...
     * Shows a single day for rooms. this consists of half hour blocks.
     *
     * @author: rs
     *
     * @type Object
    ...
    var Calendar = {
        ...
        init: function (settings) {
            ...
            Calendar.config = {
                ...
                timeblockSrcUri: '/api/calendar/room_day_timeblock.json',
    ...
    window.Oktolab.RoomDayCalendar = Calendar;
